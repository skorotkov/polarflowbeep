rem copy PolarFlowBeep_2.3.0.apk .\phone\res\raw\android_wear_micro_apk.apk 
copy watch-dp\patched\build\outputs\apk\patched-release.apk .\phone\res\raw\android_wear_micro_apk.apk 
