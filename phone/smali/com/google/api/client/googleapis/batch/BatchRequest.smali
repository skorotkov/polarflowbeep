...
.method public constructor <init>(Lcom/google/api/client/http/HttpTransport;Lcom/google/api/client/http/HttpRequestInitializer;)V
    ...
    iput-object v0, p0, Lcom/google/api/client/googleapis/batch/BatchRequest;->a:Ljava/util/List;
...
.method public execute()V
    ...
    iget-object v0, p0, Lcom/google/api/client/googleapis/batch/BatchRequest;->a:Ljava/util/List;
    ...
    iget-object v7, p0, Lcom/google/api/client/googleapis/batch/BatchRequest;->a:Ljava/util/List;
    ...
    invoke-virtual {v11, v12, v8}, Lcom/google/api/client/http/HttpHeaders;->set(Ljava/lang/String;Ljava/lang/Object;)Lcom/google/api/client/http/HttpHeaders;

    move-result-object v8

    new-instance v11, Lcom/google/api/client/googleapis/batch/HttpRequestContent;

    iget-object v9, v9, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->d:Lcom/google/api/client/http/HttpRequest;
    ...
    iget-object v10, p0, Lcom/google/api/client/googleapis/batch/BatchRequest;->a:Ljava/util/List;
    ...
    :goto_3
    iget-boolean v7, v9, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->a:Z

    if-eqz v7, :cond_4

    invoke-virtual {v9}, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->a()V
    :try_end_0
    ...
    iget-object v6, v9, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->b:Ljava/util/List;
    ...
    iput-object v6, p0, Lcom/google/api/client/googleapis/batch/BatchRequest;->a:Ljava/util/List;

    iget-boolean v6, v9, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->c:Z
