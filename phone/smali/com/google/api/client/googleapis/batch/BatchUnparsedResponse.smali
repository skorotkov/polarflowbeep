...
.method constructor <init>(Ljava/io/InputStream;Ljava/lang/String;Ljava/util/List;Z)V
    ...
    iput-boolean v0, p0, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->a:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->b:Ljava/util/List;
...
.method private checkForFinalBoundary(Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->a:Z
...
.method private getParsedDataClass(Ljava/lang/Class;Lcom/google/api/client/http/HttpResponse;Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;)Ljava/lang/Object;
    ...
    :cond_0
    iget-object p3, p3, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->d:Lcom/google/api/client/http/HttpRequest;
...
.method private parseAndCallback(Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;ILcom/google/api/client/http/HttpResponse;)V
    ...
    iget-object v0, p1, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->a:Lcom/google/api/client/googleapis/batch/BatchCallback;

    invoke-virtual {p3}, Lcom/google/api/client/http/HttpResponse;->getHeaders()Lcom/google/api/client/http/HttpHeaders;

    move-result-object v1

    iget-object v2, p1, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->d:Lcom/google/api/client/http/HttpRequest;
    ...
    iget-object v3, p1, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->d:Lcom/google/api/client/http/HttpRequest;
    ...
    iput-boolean v4, p0, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->c:Z
    ...
    :cond_0
    iget-object p2, p1, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->b:Ljava/lang/Class;
    ...
    :cond_1
    iget-object p2, p1, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->d:Lcom/google/api/client/http/HttpRequest;
    ...
    iget-object v5, p1, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->d:Lcom/google/api/client/http/HttpRequest;
    ...
    iput-boolean v6, p0, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->c:Z
    ...
    iget-boolean p2, p0, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->c:Z
    ...
    :cond_7
    iget-object p2, p0, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->b:Ljava/util/List;
    ...
    :cond_9
    iget-object p2, p1, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->c:Ljava/lang/Class;
...
.method a()V
    ...
    invoke-static {v8}, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->trimCrlf([B)Ljava/io/InputStream;
    ...
    :cond_4
    new-instance v9, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse$1;

    iget-object v10, p0, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->inputStream:Ljava/io/InputStream;

    invoke-static {v10, v6, v7}, Lcom/google/api/client/util/ByteStreams;->limit(Ljava/io/InputStream;J)Ljava/io/InputStream;

    move-result-object v10

    invoke-direct {v9, p0, v10}, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse$1;-><init>(Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;Ljava/io/InputStream;)V
    ...
    :goto_3
    invoke-direct {p0, v0, v8, v2, v3}, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->getFakeResponse(ILjava/io/InputStream;Ljava/util/List;Ljava/util/List;)Lcom/google/api/client/http/HttpResponse;

    move-result-object v2

    iget-object v3, p0, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->requestInfos:Ljava/util/List;
    ...
    invoke-direct {p0, v1, v0, v2}, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->parseAndCallback(Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;ILcom/google/api/client/http/HttpResponse;)V
