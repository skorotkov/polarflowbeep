...
.method private addTransition(Ljava/util/ArrayList;Lorg/joda/time/tz/DateTimeZoneBuilder$e;)Z
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0}, Lorg/joda/time/tz/DateTimeZoneBuilder$e;->c()I

    move-result v5

    :cond_2
    invoke-virtual {v3}, Lorg/joda/time/tz/DateTimeZoneBuilder$e;->c()I
    ...
    invoke-virtual {p2, v0, v1}, Lorg/joda/time/tz/DateTimeZoneBuilder$e;->a(J)Lorg/joda/time/tz/DateTimeZoneBuilder$e;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Lorg/joda/time/tz/DateTimeZoneBuilder;->addTransition(Ljava/util/ArrayList;Lorg/joda/time/tz/DateTimeZoneBuilder$e;)Z
...
.method private getLastRuleSet()Lorg/joda/time/tz/DateTimeZoneBuilder$d;
    .locals 9
...
.method public addRecurringSavings(Ljava/lang/String;IIICIIIZI)Lorg/joda/time/tz/DateTimeZoneBuilder;
    ...
    invoke-direct {v2, v9, v3, v4}, Lorg/joda/time/tz/DateTimeZoneBuilder$b;-><init>(Lorg/joda/time/tz/DateTimeZoneBuilder$a;Ljava/lang/String;I)V

    new-instance v3, Lorg/joda/time/tz/DateTimeZoneBuilder$c;

    invoke-direct {v3, v2, v0, v1}, Lorg/joda/time/tz/DateTimeZoneBuilder$c;-><init>(Lorg/joda/time/tz/DateTimeZoneBuilder$b;II)V

    invoke-direct {p0}, Lorg/joda/time/tz/DateTimeZoneBuilder;->getLastRuleSet()Lorg/joda/time/tz/DateTimeZoneBuilder$d;
...
.method public setStandardOffset(I)Lorg/joda/time/tz/DateTimeZoneBuilder;
    ...
    invoke-virtual {v0, p1}, Lorg/joda/time/tz/DateTimeZoneBuilder$d;->a(I)V
...
.method public toDateTimeZone(Ljava/lang/String;Z)Lorg/joda/time/DateTimeZone;
    ...
    :cond_1
    invoke-direct {p0, v0, v8}, Lorg/joda/time/tz/DateTimeZoneBuilder;->addTransition(Ljava/util/ArrayList;Lorg/joda/time/tz/DateTimeZoneBuilder$e;)Z

    invoke-virtual {v8}, Lorg/joda/time/tz/DateTimeZoneBuilder$e;->a()J

    move-result-wide v2

    invoke-virtual {v8}, Lorg/joda/time/tz/DateTimeZoneBuilder$e;->e()I
    ...
    invoke-direct {p0, v0, v2}, Lorg/joda/time/tz/DateTimeZoneBuilder;->addTransition(Ljava/util/ArrayList;Lorg/joda/time/tz/DateTimeZoneBuilder$e;)Z
    ...
    invoke-virtual {v2}, Lorg/joda/time/tz/DateTimeZoneBuilder$e;->e()I
    ...
    :cond_4
    :goto_2
    invoke-virtual {v9, v8}, Lorg/joda/time/tz/DateTimeZoneBuilder$d;->b(I)J
    ...
    invoke-virtual {p2}, Lorg/joda/time/tz/DateTimeZoneBuilder$e;->c()I
