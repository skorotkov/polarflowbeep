...
.field private final iParser:Lorg/joda/time/format/c;

.field private final iPivotYear:Ljava/lang/Integer;

.field private final iPrinter:Lorg/joda/time/format/e;
...
.method constructor <init>(Lorg/joda/time/format/e;Lorg/joda/time/format/c;)V
    ...
    iput-object p1, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/e;

    iput-object p2, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lorg/joda/time/format/c;
...
.method private printTo(Ljava/lang/Appendable;JLorg/joda/time/Chronology;)V
    ...
    invoke-direct/range {p0 .. p0}, Lorg/joda/time/format/DateTimeFormatter;->requirePrinter()Lorg/joda/time/format/e;
...
.method private requireParser()Lorg/joda/time/format/c;
    .locals 2

    iget-object v0, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lorg/joda/time/format/c;
...
.method private requirePrinter()Lorg/joda/time/format/e;
    .locals 2

    iget-object v0, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/e;
...
# virtual methods
.method a()Lorg/joda/time/format/e;
    .locals 1
...
.method b()Lorg/joda/time/format/c;
    .locals 1
...
.method public parseDateTime(Ljava/lang/String;)Lorg/joda/time/DateTime;
    ...
    invoke-direct {p0}, Lorg/joda/time/format/DateTimeFormatter;->requireParser()Lorg/joda/time/format/c;
...
.method public print(J)Ljava/lang/String;
    ...
    invoke-direct {p0}, Lorg/joda/time/format/DateTimeFormatter;->requirePrinter()Lorg/joda/time/format/e;
...
.method public withChronology(Lorg/joda/time/Chronology;)Lorg/joda/time/format/DateTimeFormatter;
    ...
    iget-object v2, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/e;

    iget-object v3, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lorg/joda/time/format/c;
...
.method public withDefaultYear(I)Lorg/joda/time/format/DateTimeFormatter;
    ...
    iget-object v1, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/e;

    iget-object v2, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lorg/joda/time/format/c;
...
.method public withOffsetParsed()Lorg/joda/time/format/DateTimeFormatter;
    ...
    iget-object v3, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/e;

    iget-object v4, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lorg/joda/time/format/c;
