...
.field private iSavedFields:[Lorg/joda/time/format/DateTimeParserBucket$a;
...
.method public constructor <init>(JLorg/joda/time/Chronology;Ljava/util/Locale;Ljava/lang/Integer;I)V
    ...
    iput-object p1, p0, Lorg/joda/time/format/DateTimeParserBucket;->iSavedFields:[Lorg/joda/time/format/DateTimeParserBucket$a;
...
.method static synthetic c(Lorg/joda/time/format/DateTimeParserBucket;)[Lorg/joda/time/format/DateTimeParserBucket$a;
    ...
    iget-object p0, p0, Lorg/joda/time/format/DateTimeParserBucket;->iSavedFields:[Lorg/joda/time/format/DateTimeParserBucket$a;
...
.method private obtainSaveField()Lorg/joda/time/format/DateTimeParserBucket$a;
    .locals 4

    iget-object v0, p0, Lorg/joda/time/format/DateTimeParserBucket;->iSavedFields:[Lorg/joda/time/format/DateTimeParserBucket$a;
    ...
    iput-object v2, p0, Lorg/joda/time/format/DateTimeParserBucket;->iSavedFields:[Lorg/joda/time/format/DateTimeParserBucket$a;
...
.method private static sort([Lorg/joda/time/format/DateTimeParserBucket$a;I)V
    .locals 5
...
.method public computeMillis(ZLjava/lang/CharSequence;)J
    ...
    iput-object v0, p0, Lorg/joda/time/format/DateTimeParserBucket;->iSavedFields:[Lorg/joda/time/format/DateTimeParserBucket$a;

    iput-boolean v3, p0, Lorg/joda/time/format/DateTimeParserBucket;->iSavedFieldsShared:Z

    :cond_0
    invoke-static {v0, v1}, Lorg/joda/time/format/DateTimeParserBucket;->sort([Lorg/joda/time/format/DateTimeParserBucket$a;I)V
    ...
    invoke-virtual {v6, v4, v5, p1}, Lorg/joda/time/format/DateTimeParserBucket$a;->a(JZ)J
    ...
    :goto_2
    invoke-virtual {v2, v4, v5, v6}, Lorg/joda/time/format/DateTimeParserBucket$a;->a(JZ)J
...
.method public saveField(Lorg/joda/time/DateTimeField;I)V
    ...
    invoke-direct {p0}, Lorg/joda/time/format/DateTimeParserBucket;->obtainSaveField()Lorg/joda/time/format/DateTimeParserBucket$a;
