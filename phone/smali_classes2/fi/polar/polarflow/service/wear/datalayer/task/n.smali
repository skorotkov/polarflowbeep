.class public Lfi/polar/polarflow/service/wear/datalayer/task/n;
...
.method private static a(Lprotocol/PftpResponse$PbPFtpDiskSpaceResult;)Ljava/lang/String;
    .locals 3
    ...
    const-string v1, ", totalFragments="
...
# virtual methods
.method protected a()Lprotocol/PftpResponse$PbPFtpDiskSpaceResult;
    .locals 5

    invoke-virtual {p0}, Lfi/polar/polarflow/service/wear/datalayer/task/n;->c()[B
    ...
    :try_start_1
    const-string v1, "DiskSpaceQueryTask"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "GET_DISK_SPACE query succeeded "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-static {v0}, Lfi/polar/polarflow/service/wear/datalayer/task/n;->a(Lprotocol/PftpResponse$PbPFtpDiskSpaceResult;)Ljava/lang/String;
    ...
    :goto_0
    const-string v2, "DiskSpaceQueryTask"

    const-string v3, "Failed to parse PbPFtpDiskSpaceResult"
    ...
    :cond_0
    const-string v0, "DiskSpaceQueryTask"

    const-string v2, "GET_DISK_SPACE query failed"
...
.method protected synthetic b()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lfi/polar/polarflow/service/wear/datalayer/task/n;->a()Lprotocol/PftpResponse$PbPFtpDiskSpaceResult;
