...
.method private addTransition(Ljava/util/ArrayList;Lorg/joda/time/tz/h;)Z
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v0, Lorg/joda/time/tz/h;

    .line 411
    invoke-virtual {p2, v0}, Lorg/joda/time/tz/h;->a(Lorg/joda/time/tz/h;)Z
    ...
    check-cast v1, Lorg/joda/time/tz/h;

    invoke-virtual {v1}, Lorg/joda/time/tz/h;->c()I

    move-result v1

    .line 421
    :cond_2
    invoke-virtual {v0}, Lorg/joda/time/tz/h;->c()I

    move-result v4

    .line 423
    invoke-virtual {v0}, Lorg/joda/time/tz/h;->a()J
    ...
    .line 424
    invoke-virtual {p2}, Lorg/joda/time/tz/h;->a()J
    ...
    .line 432
    invoke-direct {p0, p1, p2}, Lorg/joda/time/tz/DateTimeZoneBuilder;->addTransition(Ljava/util/ArrayList;Lorg/joda/time/tz/h;)Z
...
.method private getLastRuleSet()Lorg/joda/time/tz/g;
    .locals 8
    ...
    check-cast v0, Lorg/joda/time/tz/g;
...
.method public static readFrom(Ljava/io/DataInput;Ljava/lang/String;)Lorg/joda/time/DateTimeZone;
    ...
    .line 119
    :sswitch_1
    invoke-static {p0, p1}, Lorg/joda/time/tz/d;->a(Ljava/io/DataInput;Ljava/lang/String;)Lorg/joda/time/tz/d;
...
.method public addCutover(ICIIIZI)Lorg/joda/time/tz/DateTimeZoneBuilder;
    ...
    invoke-direct/range {v0 .. v6}, Lorg/joda/time/tz/c;-><init>(CIIIZI)V
    ...
    check-cast v1, Lorg/joda/time/tz/g;

    .line 256
    invoke-virtual {v1, p1, v0}, Lorg/joda/time/tz/g;->a(ILorg/joda/time/tz/c;)V

    .line 258
    :cond_0
    iget-object v0, p0, Lorg/joda/time/tz/DateTimeZoneBuilder;->iRuleSets:Ljava/util/ArrayList;

    new-instance v1, Lorg/joda/time/tz/g;

    invoke-direct {v1}, Lorg/joda/time/tz/g;-><init>()V
...
.method public addRecurringSavings(Ljava/lang/String;IIICIIIZI)Lorg/joda/time/tz/DateTimeZoneBuilder;
    ...
    invoke-direct {v1, v0, p1, p2}, Lorg/joda/time/tz/e;-><init>(Lorg/joda/time/tz/c;Ljava/lang/String;I)V

    .line 313
    new-instance v0, Lorg/joda/time/tz/f;

    invoke-direct {v0, v1, p3, p4}, Lorg/joda/time/tz/f;-><init>(Lorg/joda/time/tz/e;II)V

    .line 314
    invoke-direct {p0}, Lorg/joda/time/tz/DateTimeZoneBuilder;->getLastRuleSet()Lorg/joda/time/tz/g;

    move-result-object v1

    invoke-virtual {v1, v0}, Lorg/joda/time/tz/g;->a(Lorg/joda/time/tz/f;)V
...
.method public setFixedSavings(Ljava/lang/String;I)Lorg/joda/time/tz/DateTimeZoneBuilder;
    ...
    invoke-virtual {v0, p1, p2}, Lorg/joda/time/tz/g;->a(Ljava/lang/String;I)V
...
.method public setStandardOffset(I)Lorg/joda/time/tz/DateTimeZoneBuilder;
    ...
    invoke-virtual {v0, p1}, Lorg/joda/time/tz/g;->a(I)V
...
.method public toDateTimeZone(Ljava/lang/String;Z)Lorg/joda/time/DateTimeZone;
    ...
    .line 351
    invoke-virtual {v0, v2, v3}, Lorg/joda/time/tz/g;->a(J)Lorg/joda/time/tz/h;
    ...
    .line 355
    :cond_1
    invoke-direct {p0, v7, v1}, Lorg/joda/time/tz/DateTimeZoneBuilder;->addTransition(Ljava/util/ArrayList;Lorg/joda/time/tz/h;)Z

    .line 356
    invoke-virtual {v1}, Lorg/joda/time/tz/h;->a()J

    move-result-wide v2

    .line 357
    invoke-virtual {v1}, Lorg/joda/time/tz/h;->e()I

    move-result v1

    .line 360
    new-instance v9, Lorg/joda/time/tz/g;

    invoke-direct {v9, v0}, Lorg/joda/time/tz/g;-><init>(Lorg/joda/time/tz/g;)V
    ...
    :cond_2
    :goto_2
    invoke-virtual {v9, v2, v3, v0}, Lorg/joda/time/tz/g;->a(JI)Lorg/joda/time/tz/h;
    ...
    .line 363
    invoke-direct {p0, v7, v4}, Lorg/joda/time/tz/DateTimeZoneBuilder;->addTransition(Ljava/util/ArrayList;Lorg/joda/time/tz/h;)Z
    ...
    .line 379
    :cond_3
    invoke-virtual {v9, v0}, Lorg/joda/time/tz/g;->b(I)J
    ...
    .line 372
    invoke-virtual {v9, p1}, Lorg/joda/time/tz/g;->a(Ljava/lang/String;)Lorg/joda/time/tz/b;
    ...
    .line 392
    invoke-virtual {v0}, Lorg/joda/time/tz/h;->b()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lorg/joda/time/tz/h;->d()I
    ...
    .line 396
    :cond_9
    invoke-static {p1, p2, v7, v4}, Lorg/joda/time/tz/d;->a(Ljava/lang/String;ZLjava/util/ArrayList;Lorg/joda/time/tz/b;)Lorg/joda/time/tz/d;

    move-result-object v4

    .line 397
    invoke-virtual {v4}, Lorg/joda/time/tz/d;->a()Z
...
.method public writeTo(Ljava/lang/String;Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v0, p2}, Lorg/joda/time/tz/d;->a(Ljava/io/DataOutput;)V
