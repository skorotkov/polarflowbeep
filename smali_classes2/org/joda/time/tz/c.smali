.class final Lorg/joda/time/tz/c;
...
.method constructor <init>(CIIIZI)V
    ...
    .line 509
    :cond_0
    iput-char p1, p0, Lorg/joda/time/tz/c;->a:C

    .line 510
    iput p2, p0, Lorg/joda/time/tz/c;->b:I

    .line 511
    iput p3, p0, Lorg/joda/time/tz/c;->c:I

    .line 512
    iput p4, p0, Lorg/joda/time/tz/c;->d:I

    .line 513
    iput-boolean p5, p0, Lorg/joda/time/tz/c;->e:Z

    .line 514
    iput p6, p0, Lorg/joda/time/tz/c;->f:I
...
.method private a(Lorg/joda/time/Chronology;J)J
    ...
    .line 672
    :try_start_0
    invoke-direct {p0, p1, p2, p3}, Lorg/joda/time/tz/c;->c(Lorg/joda/time/Chronology;J)J
    :try_end_0
    ...
    .line 674
    iget v1, p0, Lorg/joda/time/tz/c;->b:I
...
.method static a(Ljava/io/DataInput;)Lorg/joda/time/tz/c;
    .locals 8
...
.method private c(Lorg/joda/time/Chronology;J)J
    ...
    .line 706
    iget v0, p0, Lorg/joda/time/tz/c;->c:I
    ...
    iget v3, p0, Lorg/joda/time/tz/c;->c:I
...
.method private d(Lorg/joda/time/Chronology;J)J
    ...
    .line 718
    iget v1, p0, Lorg/joda/time/tz/c;->d:I
    ...
    .line 720
    iget-boolean v1, p0, Lorg/joda/time/tz/c;->e:Z
...
.method public a(III)J
    ...
    .prologue
    .line 522
    iget-char v0, p0, Lorg/joda/time/tz/c;->a:C
    ...
    iget v4, p0, Lorg/joda/time/tz/c;->b:I
    ...
    iget v4, p0, Lorg/joda/time/tz/c;->f:I
    ...
    .line 534
    invoke-direct {p0, v2, v0, v1}, Lorg/joda/time/tz/c;->c(Lorg/joda/time/Chronology;J)J

    move-result-wide v0

    .line 536
    iget v3, p0, Lorg/joda/time/tz/c;->d:I

    if-eqz v3, :cond_1

    .line 537
    invoke-direct {p0, v2, v0, v1}, Lorg/joda/time/tz/c;->d(Lorg/joda/time/Chronology;J)J
...
.method public a(JII)J
    ...
    .line 549
    iget-char v1, p0, Lorg/joda/time/tz/c;->a:C
    ...
    iget v5, p0, Lorg/joda/time/tz/c;->b:I
    ...
    iget v6, p0, Lorg/joda/time/tz/c;->f:I
    ...
    .line 565
    invoke-direct {p0, v4, v0, v1}, Lorg/joda/time/tz/c;->a(Lorg/joda/time/Chronology;J)J

    move-result-wide v0

    .line 567
    iget v5, p0, Lorg/joda/time/tz/c;->d:I
    ...
    .line 573
    :cond_3
    invoke-direct {p0, v4, v0, v1}, Lorg/joda/time/tz/c;->d(Lorg/joda/time/Chronology;J)J
    ...
    iget v3, p0, Lorg/joda/time/tz/c;->b:I
...
.method public a(Ljava/io/DataOutput;)V
    ...
    .line 660
    iget v0, p0, Lorg/joda/time/tz/c;->b:I
    ...
    .line 662
    iget v0, p0, Lorg/joda/time/tz/c;->d:I

    invoke-interface {p1, v0}, Ljava/io/DataOutput;->writeByte(I)V

    .line 663
    iget-boolean v0, p0, Lorg/joda/time/tz/c;->e:Z

    invoke-interface {p1, v0}, Ljava/io/DataOutput;->writeBoolean(Z)V

    .line 664
    iget v0, p0, Lorg/joda/time/tz/c;->f:I
...
.method public b(JII)J
    ...
    .line 607
    invoke-direct {p0, v4, v0, v1}, Lorg/joda/time/tz/c;->b(Lorg/joda/time/Chronology;J)J
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 632
    :cond_1
    instance-of v2, p1, Lorg/joda/time/tz/c;
    ...
    .line 634
    iget-char v2, p0, Lorg/joda/time/tz/c;->a:C

    iget-char v3, p1, Lorg/joda/time/tz/c;->a:C

    if-ne v2, v3, :cond_2

    iget v2, p0, Lorg/joda/time/tz/c;->b:I

    iget v3, p1, Lorg/joda/time/tz/c;->b:I

    if-ne v2, v3, :cond_2

    iget v2, p0, Lorg/joda/time/tz/c;->c:I

    iget v3, p1, Lorg/joda/time/tz/c;->c:I

    if-ne v2, v3, :cond_2

    iget v2, p0, Lorg/joda/time/tz/c;->d:I

    iget v3, p1, Lorg/joda/time/tz/c;->d:I

    if-ne v2, v3, :cond_2

    iget-boolean v2, p0, Lorg/joda/time/tz/c;->e:Z

    iget-boolean v3, p1, Lorg/joda/time/tz/c;->e:Z

    if-ne v2, v3, :cond_2

    iget v2, p0, Lorg/joda/time/tz/c;->f:I

    iget v3, p1, Lorg/joda/time/tz/c;->f:I
