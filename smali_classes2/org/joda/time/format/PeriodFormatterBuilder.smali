...
.field private iFieldFormatters:[Lorg/joda/time/format/ac;
...
.field private iPrefix:Lorg/joda/time/format/af;
...
.method private appendField(II)V
    ...
    .line 589
    new-instance v0, Lorg/joda/time/format/ac;
    ...
    iget-object v6, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->iFieldFormatters:[Lorg/joda/time/format/ac;

    iget-object v7, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->iPrefix:Lorg/joda/time/format/af;

    move v1, p2

    move v5, p1

    invoke-direct/range {v0 .. v8}, Lorg/joda/time/format/ac;-><init>(IIIZI[Lorg/joda/time/format/ac;Lorg/joda/time/format/af;Lorg/joda/time/format/af;)V
    ...
    .line 592
    iget-object v1, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->iFieldFormatters:[Lorg/joda/time/format/ac;

    aput-object v0, v1, p1

    .line 593
    iput-object v8, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->iPrefix:Lorg/joda/time/format/af;

    .line 594
    return-void
.end method

.method private appendPrefix(Lorg/joda/time/format/af;)Lorg/joda/time/format/PeriodFormatterBuilder;
    .locals 2
    ...
    .line 436
    :cond_0
    iget-object v0, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->iPrefix:Lorg/joda/time/format/af;
    ...
    iget-object v1, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->iPrefix:Lorg/joda/time/format/af;

    invoke-direct {v0, v1, p1}, Lorg/joda/time/format/ab;-><init>(Lorg/joda/time/format/af;Lorg/joda/time/format/af;)V

    move-object p1, v0

    .line 439
    :cond_1
    iput-object p1, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->iPrefix:Lorg/joda/time/format/af;
...
.method private appendSeparator(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;ZZ)Lorg/joda/time/format/PeriodFormatterBuilder;
    ...
    .line 836
    new-instance v0, Lorg/joda/time/format/aj;

    sget-object v4, Lorg/joda/time/format/ae;->a:Lorg/joda/time/format/ae;

    sget-object v5, Lorg/joda/time/format/ae;->a:Lorg/joda/time/format/ae;
    ...
    invoke-direct/range {v0 .. v7}, Lorg/joda/time/format/aj;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Lorg/joda/time/format/PeriodPrinter;Lorg/joda/time/format/PeriodParser;ZZ)V
    ...
    instance-of v3, v3, Lorg/joda/time/format/aj;
    ...
    check-cast v0, Lorg/joda/time/format/aj;
...
.method private appendSuffix(Lorg/joda/time/format/af;)Lorg/joda/time/format/PeriodFormatterBuilder;
    .locals 4
    ...
    instance-of v1, v0, Lorg/joda/time/format/ac;
    ...
    .line 702
    new-instance v1, Lorg/joda/time/format/ac;

    check-cast v0, Lorg/joda/time/format/ac;

    invoke-direct {v1, v0, p1}, Lorg/joda/time/format/ac;-><init>(Lorg/joda/time/format/ac;Lorg/joda/time/format/af;)V
    ...
    .line 705
    iget-object v0, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->iFieldFormatters:[Lorg/joda/time/format/ac;

    invoke-virtual {v1}, Lorg/joda/time/format/ac;->a()I
...
.method private clearPrefix()V
    ...
    iput-object v0, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->iPrefix:Lorg/joda/time/format/af;
...
.method private static createComposite(Ljava/util/List;)[Ljava/lang/Object;
    ...
    .line 920
    new-instance v1, Lorg/joda/time/format/aa;

    invoke-direct {v1, p0}, Lorg/joda/time/format/aa;-><init>(Ljava/util/List;)V
    ...
    sget-object v1, Lorg/joda/time/format/ae;->a:Lorg/joda/time/format/ae;
...
.method private static toFormatter(Ljava/util/List;ZZ)Lorg/joda/time/format/PeriodFormatter;
    ...
    instance-of v0, v0, Lorg/joda/time/format/aj;
    ...
    .line 897
    invoke-static {v0}, Lorg/joda/time/format/aj;->a(Lorg/joda/time/format/aj;)Lorg/joda/time/format/PeriodParser;

    move-result-object v2

    if-nez v2, :cond_1

    invoke-static {v0}, Lorg/joda/time/format/aj;->b(Lorg/joda/time/format/aj;)Lorg/joda/time/format/PeriodPrinter;
    ...
    invoke-virtual {v0, v2, v1}, Lorg/joda/time/format/aj;->a(Lorg/joda/time/format/PeriodPrinter;Lorg/joda/time/format/PeriodParser;)Lorg/joda/time/format/aj;
...
.method public appendLiteral(Ljava/lang/String;)Lorg/joda/time/format/PeriodFormatterBuilder;
    ...
    invoke-direct {v0, p1}, Lorg/joda/time/format/ae;-><init>(Ljava/lang/String;)V
...
.method public appendPrefix(Ljava/lang/String;)Lorg/joda/time/format/PeriodFormatterBuilder;
    ...
    .line 360
    :cond_0
    new-instance v0, Lorg/joda/time/format/ak;

    invoke-direct {v0, p1}, Lorg/joda/time/format/ak;-><init>(Ljava/lang/String;)V

    invoke-direct {p0, v0}, Lorg/joda/time/format/PeriodFormatterBuilder;->appendPrefix(Lorg/joda/time/format/af;)Lorg/joda/time/format/PeriodFormatterBuilder;
...
.method public appendPrefix(Ljava/lang/String;Ljava/lang/String;)Lorg/joda/time/format/PeriodFormatterBuilder;
    ...
    .line 380
    :cond_1
    new-instance v0, Lorg/joda/time/format/ag;

    invoke-direct {v0, p1, p2}, Lorg/joda/time/format/ag;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public appendPrefix([Ljava/lang/String;[Ljava/lang/String;)Lorg/joda/time/format/PeriodFormatterBuilder;
    ...
    .line 421
    :cond_1
    new-instance v0, Lorg/joda/time/format/ah;

    invoke-direct {v0, p1, p2}, Lorg/joda/time/format/ah;-><init>([Ljava/lang/String;[Ljava/lang/String;)V
...
.method public appendSuffix(Ljava/lang/String;)Lorg/joda/time/format/PeriodFormatterBuilder;
    ...
    invoke-direct {p0, v0}, Lorg/joda/time/format/PeriodFormatterBuilder;->appendSuffix(Lorg/joda/time/format/af;)Lorg/joda/time/format/PeriodFormatterBuilder;
...
.method public clear()V
    ...
    .line 197
    new-array v0, v2, [Lorg/joda/time/format/ac;

    iput-object v0, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->iFieldFormatters:[Lorg/joda/time/format/ac;
...
.method public toFormatter()Lorg/joda/time/format/PeriodFormatter;
    ...
    .line 133
    iget-object v2, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->iFieldFormatters:[Lorg/joda/time/format/ac;
    ...
    .line 135
    iget-object v5, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->iFieldFormatters:[Lorg/joda/time/format/ac;

    invoke-virtual {v4, v5}, Lorg/joda/time/format/ac;->a([Lorg/joda/time/format/ac;)V
    ...
    invoke-virtual {v0}, [Lorg/joda/time/format/ac;->clone()Ljava/lang/Object;
