...
.method constructor <init>(III)V
    ...
    .line 798
    iput p1, p0, Lorg/joda/time/format/a;->b:I

    .line 799
    iput p2, p0, Lorg/joda/time/format/a;->c:I

    .line 800
    iput p3, p0, Lorg/joda/time/format/a;->d:I
...
.method private b(Ljava/util/Locale;)Lorg/joda/time/format/DateTimeFormatter;
    ...
    iget v0, p0, Lorg/joda/time/format/a;->d:I

    iget v1, p0, Lorg/joda/time/format/a;->b:I

    iget v3, p0, Lorg/joda/time/format/a;->c:I

    invoke-direct {v2, v0, v1, v3, p1}, Lorg/joda/time/format/b;-><init>(IIILjava/util/Locale;)V
    ...
    .line 833
    invoke-virtual {p0, p1}, Lorg/joda/time/format/a;->a(Ljava/util/Locale;)Ljava/lang/String;
...
.method public a(Lorg/joda/time/format/DateTimeParserBucket;Ljava/lang/CharSequence;I)I
    ...
    invoke-direct {p0, v0}, Lorg/joda/time/format/a;->b(Ljava/util/Locale;)Lorg/joda/time/format/DateTimeFormatter;

    move-result-object v0

    invoke-virtual {v0}, Lorg/joda/time/format/DateTimeFormatter;->b()Lorg/joda/time/format/v;
...
.method a(Ljava/util/Locale;)Ljava/lang/String;
    ...
    .line 844
    iget v1, p0, Lorg/joda/time/format/a;->d:I
    ...
    .line 846
    :pswitch_0
    iget v0, p0, Lorg/joda/time/format/a;->b:I
    ...
    .line 849
    :pswitch_1
    iget v0, p0, Lorg/joda/time/format/a;->c:I
    ...
    iget v1, p0, Lorg/joda/time/format/a;->c:I
...
.method public a(Ljava/lang/Appendable;JLorg/joda/time/Chronology;ILorg/joda/time/DateTimeZone;Ljava/util/Locale;)V
    ...
    .prologue
    .line 810
    invoke-direct {p0, p7}, Lorg/joda/time/format/a;->b(Ljava/util/Locale;)Lorg/joda/time/format/DateTimeFormatter;

    move-result-object v0

    invoke-virtual {v0}, Lorg/joda/time/format/DateTimeFormatter;->a()Lorg/joda/time/format/x;
...
.method public a(Ljava/lang/Appendable;Lorg/joda/time/ReadablePartial;Ljava/util/Locale;)V
    ...
    .prologue
    .line 815
    invoke-direct {p0, p3}, Lorg/joda/time/format/a;->b(Ljava/util/Locale;)Lorg/joda/time/format/DateTimeFormatter;
