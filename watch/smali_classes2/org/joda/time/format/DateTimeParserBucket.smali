...
.field private iSavedFields:[Lorg/joda/time/format/q;
...
.method public constructor <init>(JLorg/joda/time/Chronology;Ljava/util/Locale;Ljava/lang/Integer;I)V
    ...
    iput-object v0, p0, Lorg/joda/time/format/DateTimeParserBucket;->iSavedFields:[Lorg/joda/time/format/q;
...
.method static synthetic a(Lorg/joda/time/format/DateTimeParserBucket;[Lorg/joda/time/format/q;)[Lorg/joda/time/format/q;
    .locals 0

    .prologue
    .line 56
    iput-object p1, p0, Lorg/joda/time/format/DateTimeParserBucket;->iSavedFields:[Lorg/joda/time/format/q;
...
.method static synthetic c(Lorg/joda/time/format/DateTimeParserBucket;)[Lorg/joda/time/format/q;
    .locals 1

    .prologue
    .line 56
    iget-object v0, p0, Lorg/joda/time/format/DateTimeParserBucket;->iSavedFields:[Lorg/joda/time/format/q;
...
.method private obtainSaveField()Lorg/joda/time/format/q;
    .locals 4
    ...
    .line 324
    iget-object v1, p0, Lorg/joda/time/format/DateTimeParserBucket;->iSavedFields:[Lorg/joda/time/format/q;
    ...
    .line 339
    new-instance v1, Lorg/joda/time/format/q;

    invoke-direct {v1}, Lorg/joda/time/format/q;-><init>()V
...
.method private static sort([Lorg/joda/time/format/q;I)V
    .locals 4
    ...
    invoke-virtual {v2, v3}, Lorg/joda/time/format/q;->a(Lorg/joda/time/format/q;)I
...
# virtual methods
.method a(Lorg/joda/time/format/v;Ljava/lang/CharSequence;)J
    .locals 3
    ...
    invoke-interface {p1, p0, p2, v0}, Lorg/joda/time/format/v;->a(Lorg/joda/time/format/DateTimeParserBucket;Ljava/lang/CharSequence;I)I
...
.method public computeMillis(ZLjava/lang/CharSequence;)J
    ...
    .line 432
    :cond_0
    invoke-static {v0, v6}, Lorg/joda/time/format/DateTimeParserBucket;->sort([Lorg/joda/time/format/q;I)V
    ...
    iget-object v3, v3, Lorg/joda/time/format/q;->a:Lorg/joda/time/DateTimeField;
    ...
    invoke-virtual {v5, v2, v3, p1}, Lorg/joda/time/format/q;->a(JZ)J
    ...
    :goto_3
    invoke-virtual {v7, v2, v3, v1}, Lorg/joda/time/format/q;->a(JZ)J
    :try_end_0
...
.method public parseMillis(Lorg/joda/time/format/DateTimeParser;Ljava/lang/CharSequence;)J
    ...
    invoke-virtual {p0, v0, p2}, Lorg/joda/time/format/DateTimeParserBucket;->a(Lorg/joda/time/format/v;Ljava/lang/CharSequence;)J
...
.method public restoreState(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, p0}, Lorg/joda/time/format/r;->a(Lorg/joda/time/format/DateTimeParserBucket;)Z
...
.method public saveField(Lorg/joda/time/DateTimeField;I)V
    ...
    .prologue
    .line 299
    invoke-direct {p0}, Lorg/joda/time/format/DateTimeParserBucket;->obtainSaveField()Lorg/joda/time/format/q;

    move-result-object v0

    invoke-virtual {v0, p1, p2}, Lorg/joda/time/format/q;->a(Lorg/joda/time/DateTimeField;I)V
...
.method public saveField(Lorg/joda/time/DateTimeFieldType;I)V
    ...
    invoke-virtual {v0, v1, p2}, Lorg/joda/time/format/q;->a(Lorg/joda/time/DateTimeField;I)V
...
.method public saveField(Lorg/joda/time/DateTimeFieldType;Ljava/lang/String;Ljava/util/Locale;)V
    ...
    invoke-virtual {v0, v1, p2, p3}, Lorg/joda/time/format/q;->a(Lorg/joda/time/DateTimeField;Ljava/lang/String;Ljava/util/Locale;)V
...
.method public saveState()Ljava/lang/Object;
    ...
    .line 354
    new-instance v0, Lorg/joda/time/format/r;

    invoke-direct {v0, p0}, Lorg/joda/time/format/r;-><init>(Lorg/joda/time/format/DateTimeParserBucket;)V
