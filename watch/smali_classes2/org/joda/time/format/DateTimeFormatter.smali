...
.field private final iParser:Lorg/joda/time/format/v;

.field private final iPivotYear:Ljava/lang/Integer;

.field private final iPrinter:Lorg/joda/time/format/x;
...
.method public constructor <init>(Lorg/joda/time/format/DateTimePrinter;Lorg/joda/time/format/DateTimeParser;)V
    ...
    invoke-direct {p0, v0, v1}, Lorg/joda/time/format/DateTimeFormatter;-><init>(Lorg/joda/time/format/x;Lorg/joda/time/format/v;)V

    .line 119
    return-void
.end method

.method constructor <init>(Lorg/joda/time/format/x;Lorg/joda/time/format/v;)V
    .locals 2
    ...
    .line 131
    iput-object p1, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/x;

    .line 132
    iput-object p2, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lorg/joda/time/format/v;
...
.method private constructor <init>(Lorg/joda/time/format/x;Lorg/joda/time/format/v;Ljava/util/Locale;ZLorg/joda/time/Chronology;Lorg/joda/time/DateTimeZone;Ljava/lang/Integer;I)V
    .locals 0
...
.method private printTo(Ljava/lang/Appendable;JLorg/joda/time/Chronology;)V
    ...
    .prologue
    .line 671
    invoke-direct {p0}, Lorg/joda/time/format/DateTimeFormatter;->requirePrinter()Lorg/joda/time/format/x;
    ...
    invoke-interface/range {v2 .. v9}, Lorg/joda/time/format/x;->a(Ljava/lang/Appendable;JLorg/joda/time/Chronology;ILorg/joda/time/DateTimeZone;Ljava/util/Locale;)V

    .line 685
    return-void
.end method

.method private requireParser()Lorg/joda/time/format/v;
    .locals 2

    .prologue
    .line 953
    iget-object v0, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lorg/joda/time/format/v;
...
.method private requirePrinter()Lorg/joda/time/format/x;
    .locals 2

    .prologue
    .line 693
    iget-object v0, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/x;
...
# virtual methods
.method a()Lorg/joda/time/format/x;
    .locals 1
...
.method b()Lorg/joda/time/format/v;
    .locals 1
...
.method public parseDateTime(Ljava/lang/String;)Lorg/joda/time/DateTime;
    ...
    .prologue
    .line 875
    invoke-direct {p0}, Lorg/joda/time/format/DateTimeFormatter;->requireParser()Lorg/joda/time/format/v;
    ...
    invoke-interface {v0, v1, p1, v2}, Lorg/joda/time/format/v;->a(Lorg/joda/time/format/DateTimeParserBucket;Ljava/lang/CharSequence;I)I
...
.method public parseInto(Lorg/joda/time/ReadWritableInstant;Ljava/lang/String;I)I
    ...
    .line 748
    invoke-interface {v0, v1, p2, p3}, Lorg/joda/time/format/v;->a(Lorg/joda/time/format/DateTimeParserBucket;Ljava/lang/CharSequence;I)I
...
.method public parseMillis(Ljava/lang/String;)J
    ...
    .line 780
    invoke-virtual {v1, v0, p1}, Lorg/joda/time/format/DateTimeParserBucket;->a(Lorg/joda/time/format/v;Ljava/lang/CharSequence;)J
...
.method public print(J)Ljava/lang/String;
    ...
    invoke-interface {v1}, Lorg/joda/time/format/x;->estimatePrintedLength()I
...
.method public printTo(Ljava/lang/Appendable;Lorg/joda/time/ReadablePartial;)V
    ...
    invoke-interface {v0, p1, p2, v1}, Lorg/joda/time/format/x;->a(Ljava/lang/Appendable;Lorg/joda/time/ReadablePartial;Ljava/util/Locale;)V
...
.method public withChronology(Lorg/joda/time/Chronology;)Lorg/joda/time/format/DateTimeFormatter;
    ...
    iget-object v1, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/x;

    iget-object v2, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lorg/joda/time/format/v;
    ...
    invoke-direct/range {v0 .. v8}, Lorg/joda/time/format/DateTimeFormatter;-><init>(Lorg/joda/time/format/x;Lorg/joda/time/format/v;Ljava/util/Locale;ZLorg/joda/time/Chronology;Lorg/joda/time/DateTimeZone;Ljava/lang/Integer;I)V
