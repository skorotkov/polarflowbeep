...
.method private append0(Lorg/joda/time/format/x;Lorg/joda/time/format/v;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    .locals 1
...
.method private isParser(Ljava/lang/Object;)Z
    ...
    .prologue
    .line 1175
    instance-of v0, p1, Lorg/joda/time/format/v;
    ...
    invoke-virtual {p1}, Lorg/joda/time/format/d;->b()Z
...
.method private isPrinter(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p1}, Lorg/joda/time/format/d;->a()Z
...
.method public append(Lorg/joda/time/format/DateTimeFormatter;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    .line 220
    :cond_0
    invoke-virtual {p1}, Lorg/joda/time/format/DateTimeFormatter;->a()Lorg/joda/time/format/x;

    move-result-object v0

    invoke-virtual {p1}, Lorg/joda/time/format/DateTimeFormatter;->b()Lorg/joda/time/format/v;

    move-result-object v1

    invoke-direct {p0, v0, v1}, Lorg/joda/time/format/DateTimeFormatterBuilder;->append0(Lorg/joda/time/format/x;Lorg/joda/time/format/v;)Lorg/joda/time/format/DateTimeFormatterBuilder;
...
.method public append(Lorg/joda/time/format/DateTimeParser;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    invoke-static {p1}, Lorg/joda/time/format/s;->a(Lorg/joda/time/format/DateTimeParser;)Lorg/joda/time/format/v;
...
.method public append(Lorg/joda/time/format/DateTimePrinter;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    .line 239
    invoke-static {p1}, Lorg/joda/time/format/t;->a(Lorg/joda/time/format/DateTimePrinter;)Lorg/joda/time/format/x;
...
.method public append(Lorg/joda/time/format/DateTimePrinter;Lorg/joda/time/format/DateTimeParser;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    invoke-static {p2}, Lorg/joda/time/format/s;->a(Lorg/joda/time/format/DateTimeParser;)Lorg/joda/time/format/v;
...
.method public append(Lorg/joda/time/format/DateTimePrinter;[Lorg/joda/time/format/DateTimeParser;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    invoke-static {v0}, Lorg/joda/time/format/s;->a(Lorg/joda/time/format/DateTimeParser;)Lorg/joda/time/format/v;

    move-result-object v0

    invoke-direct {p0, v1, v0}, Lorg/joda/time/format/DateTimeFormatterBuilder;->append0(Lorg/joda/time/format/x;Lorg/joda/time/format/v;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    .line 319
    :cond_3
    new-array v2, v1, [Lorg/joda/time/format/v;
    ...
    invoke-static {v3}, Lorg/joda/time/format/s;->a(Lorg/joda/time/format/DateTimeParser;)Lorg/joda/time/format/v;
    ...
    invoke-static {v1}, Lorg/joda/time/format/s;->a(Lorg/joda/time/format/DateTimeParser;)Lorg/joda/time/format/v;
    ...
    new-instance v1, Lorg/joda/time/format/g;

    invoke-direct {v1, v2}, Lorg/joda/time/format/g;-><init>([Lorg/joda/time/format/v;)V
...
.method public appendDecimal(Lorg/joda/time/DateTimeFieldType;II)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    invoke-direct {v0, p1, p3, v1}, Lorg/joda/time/format/p;-><init>(Lorg/joda/time/DateTimeFieldType;IZ)V
...
.method public appendFixedDecimal(Lorg/joda/time/DateTimeFieldType;I)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    invoke-direct {v0, p1, p2, v1}, Lorg/joda/time/format/e;-><init>(Lorg/joda/time/DateTimeFieldType;IZ)V
...
.method public appendLiteral(Ljava/lang/String;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    invoke-direct {v0, v1}, Lorg/joda/time/format/c;-><init>(C)V
...
.method public appendOptional(Lorg/joda/time/format/DateTimeParser;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    new-array v0, v0, [Lorg/joda/time/format/v;
    ...
    invoke-direct {v1, v0}, Lorg/joda/time/format/g;-><init>([Lorg/joda/time/format/v;)V

    invoke-direct {p0, v3, v1}, Lorg/joda/time/format/DateTimeFormatterBuilder;->append0(Lorg/joda/time/format/x;Lorg/joda/time/format/v;)Lorg/joda/time/format/DateTimeFormatterBuilder;
...
.method public appendTimeZoneId()Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    .prologue
    .line 1068
    sget-object v0, Lorg/joda/time/format/l;->a:Lorg/joda/time/format/l;

    sget-object v1, Lorg/joda/time/format/l;->a:Lorg/joda/time/format/l;
...
.method public appendTimeZoneName()Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    .line 1018
    new-instance v0, Lorg/joda/time/format/m;

    const/4 v1, 0x0

    invoke-direct {v0, v1, v2}, Lorg/joda/time/format/m;-><init>(ILjava/util/Map;)V

    invoke-direct {p0, v0, v2}, Lorg/joda/time/format/DateTimeFormatterBuilder;->append0(Lorg/joda/time/format/x;Lorg/joda/time/format/v;)Lorg/joda/time/format/DateTimeFormatterBuilder;
...
.method public appendTimeZoneName(Ljava/util/Map;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    invoke-direct {v0, v1, p1}, Lorg/joda/time/format/m;-><init>(ILjava/util/Map;)V

    .line 1032
    invoke-direct {p0, v0, v0}, Lorg/joda/time/format/DateTimeFormatterBuilder;->append0(Lorg/joda/time/format/x;Lorg/joda/time/format/v;)Lorg/joda/time/format/DateTimeFormatterBuilder;
...
.method public appendTimeZoneOffset(Ljava/lang/String;Ljava/lang/String;ZII)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    invoke-direct/range {v0 .. v5}, Lorg/joda/time/format/n;-><init>(Ljava/lang/String;Ljava/lang/String;ZII)V
...
.method public appendTwoDigitWeekyear(IZ)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    invoke-direct {v0, v1, p1, p2}, Lorg/joda/time/format/o;-><init>(Lorg/joda/time/DateTimeFieldType;IZ)V
...
.method public toFormatter()Lorg/joda/time/format/DateTimeFormatter;
    ...
    .line 110
    check-cast v1, Lorg/joda/time/format/v;
    ...
    invoke-direct {v2, v0, v1}, Lorg/joda/time/format/DateTimeFormatter;-><init>(Lorg/joda/time/format/x;Lorg/joda/time/format/v;)V
...
.method public toParser()Lorg/joda/time/format/DateTimeParser;
    ...
    .line 155
    invoke-static {v0}, Lorg/joda/time/format/w;->a(Lorg/joda/time/format/v;)Lorg/joda/time/format/DateTimeParser;
...
.method public toPrinter()Lorg/joda/time/format/DateTimePrinter;
    ...
    .line 134
    invoke-static {v0}, Lorg/joda/time/format/y;->a(Lorg/joda/time/format/x;)Lorg/joda/time/format/DateTimePrinter;
