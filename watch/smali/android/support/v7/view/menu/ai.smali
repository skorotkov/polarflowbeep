...
.field private final d:Landroid/support/v7/view/menu/m;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/m;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ai;->j:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    .line 98
    iput-object p1, p0, Landroid/support/v7/view/menu/ai;->c:Landroid/content/Context;

    .line 99
    iput-object p2, p0, Landroid/support/v7/view/menu/ai;->d:Landroid/support/v7/view/menu/m;

    .line 100
    iput-boolean p6, p0, Landroid/support/v7/view/menu/ai;->f:Z
    ...
    iget-boolean v2, p0, Landroid/support/v7/view/menu/ai;->f:Z
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/ai;->e:Landroid/support/v7/view/menu/l;

    .line 103
    iput p4, p0, Landroid/support/v7/view/menu/ai;->h:I

    .line 104
    iput p5, p0, Landroid/support/v7/view/menu/ai;->i:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/ai;->g:I

    .line 110
    iput-object p3, p0, Landroid/support/v7/view/menu/ai;->l:Landroid/view/View;

    .line 112
    new-instance v0, Landroid/support/v7/widget/de;

    iget-object v1, p0, Landroid/support/v7/view/menu/ai;->c:Landroid/content/Context;

    const/4 v2, 0x0

    iget v3, p0, Landroid/support/v7/view/menu/ai;->h:I

    iget v4, p0, Landroid/support/v7/view/menu/ai;->i:I

    invoke-direct {v0, v1, v2, v3, v4}, Landroid/support/v7/widget/de;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v0, p0, Landroid/support/v7/view/menu/ai;->a:Landroid/support/v7/widget/de;
...
.method private h()Z
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ai;->b:Landroid/view/View;

    .line 139
    iget-object v0, p0, Landroid/support/v7/view/menu/ai;->a:Landroid/support/v7/widget/de;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/de;->a(Z)V

    .line 143
    iget-object v1, p0, Landroid/support/v7/view/menu/ai;->b:Landroid/view/View;
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/ai;->j:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    .line 153
    iget-object v0, p0, Landroid/support/v7/view/menu/ai;->e:Landroid/support/v7/view/menu/l;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/de;->g(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/de;->h(I)V

    .line 159
    iget-object v0, p0, Landroid/support/v7/view/menu/ai;->a:Landroid/support/v7/widget/de;

    invoke-virtual {p0}, Landroid/support/v7/view/menu/ai;->g()Landroid/graphics/Rect;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/de;->a(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ai;->d:Landroid/support/v7/view/menu/m;
    ...
    .line 166
    iget-object v0, p0, Landroid/support/v7/view/menu/ai;->c:Landroid/content/Context;
    ...
    sget v1, Landroid/support/v7/a/h;->abc_popup_menu_header_item_layout:I
    ...
    .line 171
    iget-object v5, p0, Landroid/support/v7/view/menu/ai;->d:Landroid/support/v7/view/menu/m;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/ai;->e:Landroid/support/v7/view/menu/l;
...
.method public a()V
    ...
    .prologue
    .line 187
    invoke-direct {p0}, Landroid/support/v7/view/menu/ai;->h()Z
...
.method public a(Landroid/view/View;)V
    ...
    .prologue
    .line 293
    iput-object p1, p0, Landroid/support/v7/view/menu/ai;->l:Landroid/view/View;
...
.method public a(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    .prologue
    .line 307
    iput-object p1, p0, Landroid/support/v7/view/menu/ai;->k:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public a(Landroid/support/v7/view/menu/ak;)Z
    ...
    iget-object v3, p0, Landroid/support/v7/view/menu/ai;->b:Landroid/view/View;

    iget-boolean v4, p0, Landroid/support/v7/view/menu/ai;->f:Z

    iget v5, p0, Landroid/support/v7/view/menu/ai;->h:I

    iget v6, p0, Landroid/support/v7/view/menu/ai;->i:I
    ...
    .line 247
    iget-object v1, p0, Landroid/support/v7/view/menu/ai;->k:Landroid/widget/PopupWindow$OnDismissListener;
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/ai;->k:Landroid/widget/PopupWindow$OnDismissListener;

    .line 251
    iget-object v1, p0, Landroid/support/v7/view/menu/ai;->d:Landroid/support/v7/view/menu/m;

    invoke-virtual {v1, v7}, Landroid/support/v7/view/menu/m;->a(Z)V

    .line 254
    iget-object v1, p0, Landroid/support/v7/view/menu/ai;->a:Landroid/support/v7/widget/de;

    invoke-virtual {v1}, Landroid/support/v7/widget/de;->j()I

    move-result v1

    .line 255
    iget-object v2, p0, Landroid/support/v7/view/menu/ai;->a:Landroid/support/v7/widget/de;

    invoke-virtual {v2}, Landroid/support/v7/widget/de;->k()I
...
.method public b(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/de;->c(I)V
...
.method public c(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/de;->d(I)V
...
.method public onDismiss()V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ai;->b:Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/ai;->j:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    .line 219
    :cond_1
    iget-object v0, p0, Landroid/support/v7/view/menu/ai;->k:Landroid/widget/PopupWindow$OnDismissListener;
