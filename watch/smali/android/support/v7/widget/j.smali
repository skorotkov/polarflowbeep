...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/j;->y:Landroid/util/SparseBooleanArray;

    .line 84
    new-instance v0, Landroid/support/v7/widget/q;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/q;-><init>(Landroid/support/v7/widget/j;)V

    iput-object v0, p0, Landroid/support/v7/widget/j;->k:Landroid/support/v7/widget/q;

    .line 89
    return-void
.end method

.method static synthetic a(Landroid/support/v7/widget/j;)Landroid/support/v7/view/menu/m;
    .locals 1
...
.method static synthetic b(Landroid/support/v7/widget/j;)Landroid/support/v7/view/menu/m;
    .locals 1
...
.method static synthetic c(Landroid/support/v7/widget/j;)Landroid/support/v7/view/menu/ad;
    .locals 1
...
.method static synthetic e(Landroid/support/v7/widget/j;)Landroid/support/v7/view/menu/m;
    .locals 1
...
.method public a(Landroid/support/v7/view/menu/p;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 204
    invoke-virtual {p3, v1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/t;
...
.method public a(Landroid/content/Context;Landroid/support/v7/view/menu/m;)V
    ...
    .line 98
    iget-boolean v2, p0, Landroid/support/v7/widget/j;->p:Z
    ...
    iput-boolean v2, p0, Landroid/support/v7/widget/j;->o:Z

    .line 102
    :cond_0
    iget-boolean v2, p0, Landroid/support/v7/widget/j;->v:Z
    ...
    iput v2, p0, Landroid/support/v7/widget/j;->q:I

    .line 107
    :cond_1
    iget-boolean v2, p0, Landroid/support/v7/widget/j;->t:Z
    ...
    iput v0, p0, Landroid/support/v7/widget/j;->s:I

    .line 111
    :cond_2
    iget v0, p0, Landroid/support/v7/widget/j;->q:I

    .line 112
    iget-boolean v2, p0, Landroid/support/v7/widget/j;->o:Z

    if-eqz v2, :cond_5

    .line 113
    iget-object v2, p0, Landroid/support/v7/widget/j;->g:Landroid/support/v7/widget/n;
    ...
    invoke-direct {v2, p0, v3}, Landroid/support/v7/widget/n;-><init>(Landroid/support/v7/widget/j;Landroid/content/Context;)V

    iput-object v2, p0, Landroid/support/v7/widget/j;->g:Landroid/support/v7/widget/n;

    .line 115
    iget-boolean v2, p0, Landroid/support/v7/widget/j;->n:Z
    ...
    iget-object v3, p0, Landroid/support/v7/widget/j;->m:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v2, v3}, Landroid/support/v7/widget/n;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    .line 117
    iput-object v5, p0, Landroid/support/v7/widget/j;->m:Landroid/graphics/drawable/Drawable;

    .line 118
    iput-boolean v4, p0, Landroid/support/v7/widget/j;->n:Z
    ...
    .line 121
    iget-object v3, p0, Landroid/support/v7/widget/j;->g:Landroid/support/v7/widget/n;
    ...
    .line 128
    :goto_0
    iput v0, p0, Landroid/support/v7/widget/j;->r:I
    ...
    iput v0, p0, Landroid/support/v7/widget/j;->x:I

    .line 133
    iput-object v5, p0, Landroid/support/v7/widget/j;->z:Landroid/view/View;
    ...
    .line 125
    :cond_5
    iput-object v5, p0, Landroid/support/v7/widget/j;->g:Landroid/support/v7/widget/n;
...
.method public a(Landroid/content/res/Configuration;)V
    ...
    .prologue
    .line 137
    iget-boolean v0, p0, Landroid/support/v7/widget/j;->t:Z
...
.method public a(Landroid/graphics/drawable/Drawable;)V
    ...
    .prologue
    .line 166
    iget-object v0, p0, Landroid/support/v7/widget/j;->g:Landroid/support/v7/widget/n;
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/j;->n:Z

    .line 170
    iput-object p1, p0, Landroid/support/v7/widget/j;->m:Landroid/graphics/drawable/Drawable;
...
.method public a(Landroid/support/v7/view/menu/p;Landroid/support/v7/view/menu/ae;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/l;-><init>(Landroid/support/v7/widget/j;)V
...
.method public a(Landroid/support/v7/view/menu/ak;)Z
    ...
    invoke-direct {v2, p0, v4, p1, v3}, Landroid/support/v7/widget/k;-><init>(Landroid/support/v7/widget/j;Landroid/content/Context;Landroid/support/v7/view/menu/ak;Landroid/view/View;)V

    iput-object v2, p0, Landroid/support/v7/widget/j;->i:Landroid/support/v7/widget/k;

    .line 316
    iget-object v2, p0, Landroid/support/v7/widget/j;->i:Landroid/support/v7/widget/k;

    invoke-virtual {v2, v0}, Landroid/support/v7/widget/k;->a(Z)V

    .line 317
    iget-object v0, p0, Landroid/support/v7/widget/j;->i:Landroid/support/v7/widget/k;
...
.method public a(Landroid/view/ViewGroup;I)Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/j;->g:Landroid/support/v7/widget/n;
...
.method public b(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/p;->a()Landroid/support/v4/view/q;
    ...
    .line 244
    invoke-virtual {v0, p0}, Landroid/support/v4/view/q;->a(Landroid/support/v4/view/r;)V
    ...
    .line 253
    :goto_1
    iget-boolean v3, p0, Landroid/support/v7/widget/j;->o:Z
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/n;-><init>(Landroid/support/v7/widget/j;Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/j;->g:Landroid/support/v7/widget/n;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ActionMenuView;->b()Landroid/support/v7/widget/t;
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/j;->o:Z
...
.method public b()Z
    ...
    iget v9, v0, Landroid/support/v7/widget/j;->s:I

    .line 432
    move-object/from16 v0, p0

    iget v11, v0, Landroid/support/v7/widget/j;->r:I
    ...
    iget-boolean v13, v0, Landroid/support/v7/widget/j;->w:Z
    ...
    iget-boolean v3, v0, Landroid/support/v7/widget/j;->o:Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/j;->y:Landroid/util/SparseBooleanArray;
    ...
    iget-boolean v7, v0, Landroid/support/v7/widget/j;->u:Z
    ...
    iget v3, v0, Landroid/support/v7/widget/j;->x:I
    ...
    iget v4, v0, Landroid/support/v7/widget/j;->x:I
    ...
    iget v7, v0, Landroid/support/v7/widget/j;->x:I
    ...
    iget-object v8, v0, Landroid/support/v7/widget/j;->z:Landroid/view/View;
    ...
    iget-object v10, v0, Landroid/support/v7/widget/j;->z:Landroid/view/View;
    ...
    iput-object v8, v0, Landroid/support/v7/widget/j;->z:Landroid/view/View;

    .line 483
    :cond_6
    move-object/from16 v0, p0

    iget-boolean v10, v0, Landroid/support/v7/widget/j;->u:Z
    ...
    iget-boolean v8, v0, Landroid/support/v7/widget/j;->u:Z
    ...
    iput-object v13, v0, Landroid/support/v7/widget/j;->z:Landroid/view/View;
...
.method public c()Landroid/graphics/drawable/Drawable;
    ...
    .line 177
    :cond_0
    iget-boolean v0, p0, Landroid/support/v7/widget/j;->n:Z

    if-eqz v0, :cond_1

    .line 178
    iget-object v0, p0, Landroid/support/v7/widget/j;->m:Landroid/graphics/drawable/Drawable;
...
.method public d(Z)V
    ...
    .prologue
    .line 162
    iput-boolean p1, p0, Landroid/support/v7/widget/j;->w:Z
...
.method public d()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/j;->j:Landroid/support/v7/widget/m;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/j;->g:Landroid/support/v7/widget/n;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Landroid/support/v7/widget/p;-><init>(Landroid/support/v7/widget/j;Landroid/content/Context;Landroid/support/v7/view/menu/m;Landroid/view/View;Z)V

    .line 346
    new-instance v1, Landroid/support/v7/widget/m;

    invoke-direct {v1, p0, v0}, Landroid/support/v7/widget/m;-><init>(Landroid/support/v7/widget/j;Landroid/support/v7/widget/p;)V

    iput-object v1, p0, Landroid/support/v7/widget/j;->j:Landroid/support/v7/widget/m;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/j;->j:Landroid/support/v7/widget/m;
...
.method public e()Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/j;->j:Landroid/support/v7/widget/m;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/j;->j:Landroid/support/v7/widget/m;
    ...
    .line 371
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/j;->h:Landroid/support/v7/widget/p;
