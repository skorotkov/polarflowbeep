.class public Landroid/support/v4/b/co;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/lang/String;Ljava/util/ArrayList;Landroid/os/Bundle;IILandroid/app/Notification;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-object v4, p0, Landroid/support/v4/b/co;->a:Landroid/app/Notification$Builder;
    ...
    iput-object v4, p0, Landroid/support/v4/b/co;->b:Landroid/os/Bundle;

    .line 112
    if-eqz p21, :cond_0

    .line 113
    iget-object v4, p0, Landroid/support/v4/b/co;->b:Landroid/os/Bundle;
    ...
    .line 116
    iget-object v6, p0, Landroid/support/v4/b/co;->a:Landroid/app/Notification$Builder;
    ...
    iput-object v0, p0, Landroid/support/v4/b/co;->c:Landroid/widget/RemoteViews;

    .line 119
    move-object/from16 v0, p29

    iput-object v0, p0, Landroid/support/v4/b/co;->d:Landroid/widget/RemoteViews;

    .line 120
    move-object/from16 v0, p30

    iput-object v0, p0, Landroid/support/v4/b/co;->e:Landroid/widget/RemoteViews;
...
.method public a()Landroid/app/Notification$Builder;
    ...
    .prologue
    .line 130
    iget-object v0, p0, Landroid/support/v4/b/co;->a:Landroid/app/Notification$Builder;
...
.method public a(Landroid/support/v4/b/cs;)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/b/cl;->a(Landroid/app/Notification$Builder;Landroid/support/v4/b/cs;)V
...
.method public b()Landroid/app/Notification;
    ...
    iget-object v1, p0, Landroid/support/v4/b/co;->b:Landroid/os/Bundle;
    ...
    .line 137
    iget-object v1, p0, Landroid/support/v4/b/co;->c:Landroid/widget/RemoteViews;
    ...
    .line 140
    :cond_0
    iget-object v1, p0, Landroid/support/v4/b/co;->d:Landroid/widget/RemoteViews;
    ...
    .line 143
    :cond_1
    iget-object v1, p0, Landroid/support/v4/b/co;->e:Landroid/widget/RemoteViews;
