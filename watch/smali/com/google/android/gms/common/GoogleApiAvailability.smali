...
.method a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    :try_start_0
    instance-of v0, p1, Landroid/support/v4/b/x;
    :try_end_0
    ...
    invoke-virtual {p1}, Landroid/support/v4/b/x;->e()Landroid/support/v4/b/ae;
    ...
    invoke-virtual {v1, v0, p3}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Landroid/support/v4/b/ae;Ljava/lang/String;)V
...
.method a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    :cond_3
    new-instance v3, Landroid/support/v4/b/bw;

    invoke-direct {v3, p1}, Landroid/support/v4/b/bw;-><init>(Landroid/content/Context;)V

    const v4, 0x108008a

    invoke-virtual {v3, v4}, Landroid/support/v4/b/bw;->a(I)Landroid/support/v4/b/bw;
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/b/bw;->c(Ljava/lang/CharSequence;)Landroid/support/v4/b/bw;
    ...
    invoke-virtual {v2, v4, v5}, Landroid/support/v4/b/bw;->a(J)Landroid/support/v4/b/bw;

    move-result-object v2

    invoke-virtual {v2, v6}, Landroid/support/v4/b/bw;->a(Z)Landroid/support/v4/b/bw;

    move-result-object v2

    invoke-virtual {v2, p4}, Landroid/support/v4/b/bw;->a(Landroid/app/PendingIntent;)Landroid/support/v4/b/bw;

    move-result-object v2

    invoke-virtual {v2, v0}, Landroid/support/v4/b/bw;->a(Ljava/lang/CharSequence;)Landroid/support/v4/b/bw;

    move-result-object v0

    invoke-virtual {v0, v1}, Landroid/support/v4/b/bw;->b(Ljava/lang/CharSequence;)Landroid/support/v4/b/bw;

    move-result-object v0

    invoke-virtual {v0, v6}, Landroid/support/v4/b/bw;->b(Z)Landroid/support/v4/b/bw;

    move-result-object v0

    new-instance v2, Landroid/support/v4/b/bv;

    invoke-direct {v2}, Landroid/support/v4/b/bv;-><init>()V

    invoke-virtual {v2, v1}, Landroid/support/v4/b/bv;->a(Ljava/lang/CharSequence;)Landroid/support/v4/b/bv;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/support/v4/b/bw;->a(Landroid/support/v4/b/ck;)Landroid/support/v4/b/bw;

    move-result-object v0

    invoke-virtual {v0}, Landroid/support/v4/b/bw;->a()Landroid/app/Notification;
    ...
    sget-object v1, Lcom/google/android/gms/common/zzg;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public getErrorDialog(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, p1, p2, v0, p4}, Lcom/google/android/gms/common/GoogleApiAvailability;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/zzi;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public showErrorDialogFragment(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-virtual {p0, p1, v0, v1, p4}, Lcom/google/android/gms/common/GoogleApiAvailability;->a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public showErrorNotification(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)V
    ...
    invoke-virtual {p0, p1, v1, v2, v0}, Lcom/google/android/gms/common/GoogleApiAvailability;->a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
...
.method public zza(Landroid/app/Activity;Lcom/google/android/gms/internal/zzabf;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-virtual {p0, p1, p3, v0, p5}, Lcom/google/android/gms/common/GoogleApiAvailability;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/zzi;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, p1, v0, v1, p5}, Lcom/google/android/gms/common/GoogleApiAvailability;->a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
