.class public Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;
...
# static fields
.field private static final QUERY_AUTO_LAP:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;->QUERY_AUTO_LAP:Ljava/lang/String;
...
.method private constructor <init>(Lfi/polar/remote/representation/protobuf/ExerciseLap$PbAutoLaps;)V
    .locals 3
    ...
    invoke-virtual {p0, v2}, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;->addLap(Lfi/polar/polarflow/data/orm/LapData;)V
    ...
    invoke-virtual {p0, v0, v1}, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;->setSummaryAvgLapDuration(J)V
    ...
    invoke-virtual {p0, v0, v1}, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;->setSummaryBestLapDuration(J)V
...
.method constructor <init>(Ljava/io/InputStream;)V
    ...
    .prologue
    .line 32
    invoke-static {p1}, Lfi/polar/remote/representation/protobuf/ExerciseLap$PbAutoLaps;->parseFrom(Ljava/io/InputStream;)Lfi/polar/remote/representation/protobuf/ExerciseLap$PbAutoLaps;

    move-result-object v0

    invoke-direct {p0, v0}, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;-><init>(Lfi/polar/remote/representation/protobuf/ExerciseLap$PbAutoLaps;)V
...
.method public static varargs deleteAll(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .prologue
    .line 91
    const-class v0, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;

    .line 92
    invoke-static {v0, p1, p2}, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;->find(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/List;
    ...
    check-cast v0, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;

    .line 96
    invoke-virtual {v0}, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;->getExerciseId()J
    ...
    sget-object v6, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;->QUERY_AUTO_LAP:Ljava/lang/String;
    ...
    .line 103
    :cond_0
    invoke-virtual {v0}, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;->delete()Z
...
.method getWhereClause()Ljava/lang/String;
    ...
    .prologue
    .line 110
    sget-object v0, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;->QUERY_AUTO_LAP:Ljava/lang/String;
...
.method public bridge synthetic toPbObject()Lcom/google/protobuf/GeneratedMessageV3;
    ...
    .prologue
    .line 16
    invoke-virtual {p0}, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;->toPbObject()Lfi/polar/remote/representation/protobuf/ExerciseLap$PbAutoLaps;
...
.method public toPbObject()Lfi/polar/remote/representation/protobuf/ExerciseLap$PbAutoLaps;
    .locals 4
    ...
    .line 67
    iget-object v2, p0, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;->mLapDataList:Ljava/util/List;

    monitor-enter v2

    .line 68
    :try_start_0
    invoke-virtual {p0}, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;->getLapDataList()Ljava/util/List;
    ...
    invoke-virtual {v1, v0}, Lfi/polar/remote/representation/protobuf/ExerciseLap$PbAutoLaps$Builder;->addAutoLaps(Lfi/polar/remote/representation/protobuf/ExerciseLap$PbLap;)Lfi/polar/remote/representation/protobuf/ExerciseLap$PbAutoLaps$Builder;
    ...
    .line 72
    invoke-virtual {p0}, Lfi/polar/polarflow/data/orm/ExerciseAutoLaps;->buildLapSummary()Lfi/polar/remote/representation/protobuf/ExerciseLap$PbLapSummary;

    move-result-object v0

    invoke-virtual {v1, v0}, Lfi/polar/remote/representation/protobuf/ExerciseLap$PbAutoLaps$Builder;->setSummary(Lfi/polar/remote/representation/protobuf/ExerciseLap$PbLapSummary;)Lfi/polar/remote/representation/protobuf/ExerciseLap$PbAutoLaps$Builder;

    .line 73
    invoke-virtual {v1}, Lfi/polar/remote/representation/protobuf/ExerciseLap$PbAutoLaps$Builder;->build()Lfi/polar/remote/representation/protobuf/ExerciseLap$PbAutoLaps;
